...
<table class="atbdp_status_table widefat" cellspacing="0">
	...
	<?php foreach ( $database['database_tables']['other'] as $table => $table_data ) { ?>
		<tr>
			...
			<td class="help">&nbsp;</td>
			<td>
				<?php printf( esc_html__( 'Data: %1$.2fMB + Index: %2$.2fMB', 'directorist' ), wp_kses_post( $this->directorist_help_tip( $table_data['data'], 2 ) ), wp_kses_post( $this->directorist_help_tip( $table_data['index'], 2 ) ) ); ?>
			</td>
		</tr>
	<?php } ?>
	</tbody>
