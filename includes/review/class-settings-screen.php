...
class Settings_Screen {
	...
	public static function init() {
		add_filter( 'atbdp_listing_type_settings_layout', array( __CLASS__, 'register_layout' ) );
	...
	public static function register_layout( $layout ) {
		if ( ! isset( $layout['listing_settings']['submenu']['review'] ) ) {
			$layout['listing_settings']['submenu']['review'] = array(
