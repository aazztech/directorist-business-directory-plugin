...
class Directorist_Listing_Search_Form {
	...
	public function build_form_data() {
		...
		if ( ! empty( $search_form_fields['fields'] ) ) {
			...
			foreach ( $search_form_fields['fields'] as $key => $value ) {
				...
				$search_form_fields['fields'][ $key ]['options']   = array();
	...
	public function directory_type_nav_template() {
		...
		Helper::get_template( 'search-form/directory-type-nav', array( 'searchform' => $this ) );
	}
	...
	public function more_buttons_template() {
		Helper::get_template( 'search-form/more-buttons', array( 'searchform' => $this ) );
	}
	...
	public function render_search_shortcode( $atts = array() ) {
		...
		return Helper::get_template_contents( 'search-form-contents', array( 'searchform' => $this ) );
	}
