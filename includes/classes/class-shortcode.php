	...
	public function __construct() {
		...
		if ( is_null( self::$instance ) ) {
			...
			self::$shortcodes = apply_filters(
				...
				array(
					// Archive
					'directorist_all_listing'            => array( $this, 'listing_archive' ),
					'directorist_category'               => array( $this, 'category_archive' ),
					'directorist_tag'                    => array( $this, 'tag_archive' ),
					'directorist_location'               => array( $this, 'location_archive' ),

					// Taxonomy
					'directorist_all_categories'         => array( $this, 'all_categories' ),
					'directorist_all_locations'          => array( $this, 'all_locations' ),

					// Search
					'directorist_search_listing'         => array( $this, 'search_listing' ),
					'directorist_search_result'          => array( $this, 'search_result' ),

					// Author
					'directorist_author_profile'         => array( $this, 'author_profile' ),
					'directorist_user_dashboard'         => array( $this, 'user_dashboard' ),
					'directorist_all_authors'            => array( $this, 'all_authors' ),
					'directorist_signin_signup'          => array( $this, 'directorist_signin_signup' ),
					'directorist_custom_registration'    => array( $this, 'register_registration_shortcode' ),
					'directorist_user_login'             => array( $this, 'register_login_shortcode' ),

					// Forms
					'directorist_add_listing'            => array( $this, 'add_listing' ),

					// Checkout
					'directorist_checkout'               => array( new \ATBDP_Checkout(), 'display_checkout_content' ),
					'directorist_payment_receipt'        => array( new \ATBDP_Checkout(), 'payment_receipt' ),
					'directorist_transaction_failure'    => array( new \ATBDP_Checkout(), 'transaction_failure' ),

					// Single
					'directorist_single_listings_header' => array( $this, 'single_listings_header' ),
					'directorist_single_listing_section' => array( $this, 'single_listing_section' ),
					'directorist_single_listing_field'   => array( $this, 'single_listing_field' ),
