...
abstract class Abstract_Controller extends WP_REST_Controller {
	...
	protected function add_additional_fields_schema( $schema ) {
		...
		$schema['properties'] = apply_filters( 'directorist_rest_' . $object_type . '_schema', $schema['properties'] );
	...
	public function get_endpoint_args_for_item_schema( $method = WP_REST_Server::CREATABLE ) {
		...
		return $this->adjust_wp_5_5_datatype_compatibility( $endpoint_args );
	}
	...
	protected function check_batch_limit( $items ) {
		$limit = apply_filters( 'directorist_rest_batch_items_limit', 100, $this->get_normalized_rest_base() );
		$total = 0;
