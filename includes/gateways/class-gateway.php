...
class ATBDP_Gateway {
	...
	public function get_monetization_settings_submenus() {
		return apply_filters(
			'atbdp_monetization_settings_submenus',
			array(
				'monetization_submenu1' => array(
					...
					'controls' => apply_filters(
						'atbdp_monetization_settings_controls',
						array(
	...
	public function get_monetization_settings_fields() {
		return apply_filters(
			'atbdp_monetization_settings_fields',
			array(
				array(
					'type'        => 'toggle',
	...
	public function get_monetize_by_subscription_fields() {
		...
		return apply_filters(
			'atbdp_monetization_by_subscription_settings_fields',
			array(
				array(
					'type'        => 'notebox',
	...
	public function gateway_settings_submenu( $submenus ) {
		$submenus['gateway_submenu'] = array(
			...
			'controls' => apply_filters(
				'atbdp_gateway_settings_controls',
				array(
					'gateways' => array(
						'type'        => 'section',
	...
	public static function gateways_markup() {
		$active_gateways = get_directorist_option( 'active_gateways', array( 'bank_transfer' ) );
		$default_gw      = get_directorist_option( 'default_gateway', 'bank_transfer' );
		if ( empty( $active_gateways ) ) {
			return ''; // if the gateways are empty, vail out.
		}
