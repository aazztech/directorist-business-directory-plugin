...
class Directorist_Search_Result extends Custom_Widget_Base {
	...
	protected function render() {
		...
		$shortcode = sprintf(
			'[directorist_search_result header="%1$s" header_title="%2$s" header_sub_title="%3$s" view="%4$s" map_height="%5$s" columns="%6$s" listings_per_page="%7$s" show_pagination="%8$s" orderby="%9$s" order="%10$s" featured_only="%11$s" popular_only="%12$s"  logged_in_user_only="%13$s" ]',
