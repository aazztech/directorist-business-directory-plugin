	...
	<div class="csv-center csv-import-done">
		<div class="wc-progress-form-content directorist-importer">
			<div class="wc-actions">
				...
				<p><strong><?php echo esc_attr( $imported ); ?></strong> 
										<?php
										esc_html_e( 'listings imported', 'directorist' );
										if ( ( $failed != 'NaN' ) && ( $failed != '0' ) ) {
											?>
								&<strong><?php echo ' ' . esc_attr( $failed ); ?></strong> 
													<?php
														esc_html_e( 'were skipped.', 'directorist' );
										}
										?>
			</p>
			</div>
