...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"category":"directorist-blocks-collection","version":"1.0.0","title":"Categories","name":"directorist/all-categories","description":"Create directory category listing grid view and list view.","keywords":["all categories","category","taxonomy","term"],"attributes":{"view":{"type":"string","enum":["grid","list"],"default":"grid"},"orderby":{"type":"string","enum":["id","count","name","slug"],"default":"id"},"order":{"type":"string","enum":["asc","desc"],"default":"desc"},"cat_per_page":{"type":"number","default":6},"columns":{"type":"number","enum":[1,2,3,4,6],"default":3},"slug":{"type":"string","default":""},"logged_in_user_only":{"type":"boolean","default":false},"redirect_page_url":{"type":"string","default":""},"directory_type":{"type":"string","default":""},"default_directory_type":{"type":"string","default":""}},"supports":{"html":false},"editorScript":["file:./index.js","jquery-masonry","directorist-swiper","directorist-select2-script","directorist-all-listings","directorist-listing-slider","directorist-search-form","directorist-openstreet-map","directorist-google-map"]}');
...
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./../functions */ "./src/functions.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./block.json */ "./src/categories/block.json");
...
var Placeholder = function Placeholder() {
  return (0,_functions__WEBPACK_IMPORTED_MODULE_9__.getPlaceholder)('categories-grid');
};
  ...
  transforms: {
    from: [{
      ...
      transform: function transform(attributes) {
        ...
        return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.createBlock)('directorist/all-categories', attributes);
      }
    }]
  },
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.BlockControls, {
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__.PanelBody, {
          ...
          children: [(0,_functions__WEBPACK_IMPORTED_MODULE_9__.isMultiDirectoryEnabled)() ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_controls__WEBPACK_IMPORTED_MODULE_7__.TypesControl, {
            ...
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Number Of Categories', 'directorist'),
            type: "number",
            value: cat_per_page,
            ...
            className: "directorist-gb-fixed-control",
            help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Set the number of categories to show.', 'directorist')
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_8__.SelectControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Order By', 'directorist'),
            labelPosition: "side",
            value: orderby,
            options: [{
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('ID', 'directorist'),
              value: 'id'
            }, {
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Count', 'directorist'),
              value: 'count'
            }, {
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Name', 'directorist'),
              value: 'name'
            }, {
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__.__)('Categories', 'directorist'),
              value: 'slug'
            }],
            ...
            className: "directorist-gb-fixed-control"
          }), orderby === 'slug' ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(_controls__WEBPACK_IMPORTED_MODULE_7__.CategoryControl, {
            ...
            onChange: function onChange(logged_in_user_only) {
              return setAttributes({
                logged_in_user_only: logged_in_user_only
              });
            }
          })]
        })
