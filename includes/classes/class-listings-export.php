...
class Listings_Exporter {
	...
	// justifyDataRow
	public static function justifyDataTableRow( $data_table = array(), $tr_lengths = array() ) {
		if ( empty( $data_table ) ) {
			return $data_table; }
	...
	// verifyNativeField
	public static function verifyNativeField( $args = array() ) {
		if ( ! is_array( $args ) ) {
			return false; }
		...
		$native_fields = array( 'listing_title', 'listing_content' );
	...
	public static function updateNativeFieldData( array $row = array(), string $field_key = '', array $field_args = array() ) {
	...
	// verifyTaxonomyField
	public static function verifyTaxonomyField( $args = array() ) {
		if ( ! is_array( $args ) ) {
			return false; }
		if ( empty( $args['widget_group'] ) ) {
			return false; }
		...
		$taxonomy = array( 'category', 'location', 'tag' );
	...
	public static function updateTaxonomyFieldData( array $row = array(), string $field_key = '', array $field_args = array() ) {
		$term_map = array(
	...
	public static function verifyListingImageModuleField( $args = array() ) {
		if ( ! is_array( $args ) ) {
			return false; }
		if ( empty( $args['widget_group'] ) ) {
			return false; }
	...
	public static function updateListingImageModuleFieldsData( array $row = array(), string $field_key = '', array $field_args = array() ) {
	...
	// verifyMetaKeyField
	public static function verifyMetaKeyField( $args = array() ) {
		if ( ! is_array( $args ) ) {
			return false; }
		if ( empty( $args['widget_group'] ) ) {
			return false; }
	...
	public static function updateMetaKeyFieldData( array $row = array(), string $field_key = '', array $field_args = array() ) {
	...
	public static function verifyPriceModuleField( $args = array() ) {
		if ( ! is_array( $args ) ) {
			return false; }
		if ( empty( $args['widget_group'] ) ) {
			return false; }
	...
	public static function updatePriceModuleFieldData( array $row = array(), string $field_key = '', array $field_args = array() ) {
	...
	public static function verifyMapModuleField( $args = array() ) {
		if ( ! is_array( $args ) ) {
			return false; }
		if ( empty( $args['widget_group'] ) ) {
			return false; }
	...
	public static function updateMapModuleFieldData( array $row = array(), string $field_key = '', array $field_args = array() ) {
