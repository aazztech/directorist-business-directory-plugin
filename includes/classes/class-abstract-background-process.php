...
if ( ! class_exists( 'WP_Async_Request', false ) ) {
	include_once ATBDP_INC_DIR . 'modules/background-process/wp-async-request.php';
}

if ( ! class_exists( 'WP_Background_Process', false ) ) {
	include_once ATBDP_INC_DIR . 'modules/background-process/wp-background-process.php';
}
