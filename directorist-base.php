...
final class Directorist_Base {
	...
	public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Directorist_Base ) ) {
			...
			add_action( 'template_redirect', array( self::$instance, 'check_single_listing_page_restrictions' ) );
			add_action( 'atbdp_show_flush_messages', array( self::$instance, 'show_flush_messages' ) );
	...
	// require_files
	public static function require_files( array $files = array() ) {
