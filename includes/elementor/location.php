...
class Directorist_Location extends Custom_Widget_Base {

	public function __construct( $data = array(), $args = null ) {
		$this->az_name = __( 'Single Location', 'directorist' );
		$this->az_base = 'directorist_location';
	...
	protected function render() {
		...
		$shortcode = sprintf(
			'[directorist_location header="%1$s" header_title="%2$s" view="%3$s" map_height="%4$s" columns="%5$s" listings_per_page="%6$s" show_pagination="%7$s" orderby="%8$s" order="%9$s" logged_in_user_only="%10$s" ]',
