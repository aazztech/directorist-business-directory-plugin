...
class ATBDP_Offline_Gateway {
    ...
    {
        // add new settings
        add_filter('atbdp_monetization_settings_submenus', [$this, 'offline_gateway_settings_submenu'], 10, 1);
     ...
     */
    public function offline_gateway_settings_submenu(array $submenus): array
    {
        $submenus['offline_gateway_submenu'] =  [
            'title' => __('Offline Gateway', 'directorist'),
            'name' => 'offline_gateway_menu',
            'icon' => 'font-awesome:fa-university',
            'controls' => apply_filters('atbdp_offline_gateway_settings_controls', [
                'gateways' => [
                    'type' => 'section',
