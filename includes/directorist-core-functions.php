...
function directorist_is_multi_directory_enabled(): bool {
	return (bool) get_directorist_option( 'enable_multi_directory', false );
}

function directorist_is_guest_submission_enabled(): bool {
	return (bool) get_directorist_option( 'guest_listings', false );
}

function directorist_is_featured_listing_enabled(): bool {
	return (bool) get_directorist_option( 'enable_featured_listing' );
}

function directorist_is_monetization_enabled(): bool {
...
function directorist_can_user_renew_listings(): bool {
