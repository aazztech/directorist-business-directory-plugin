...
class Listing_Reviews_Controller extends Abstract_Controller {
	...
	public function get_items( $request ) {
		...
		return apply_filters( 'directorist_rest_response', $response, 'get_review_items', $request, $prepared_args );
	}
	...
	public function get_item( $request ) {
		...
		return apply_filters( 'directorist_rest_response', $response, 'get_review_item', $request, $request['id'] );
	}
