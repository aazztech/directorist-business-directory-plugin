...
if ( ! class_exists( 'ATBDP_Terms_Data_Store' ) ) :
	class ATBDP_Terms_Data_Store {
		// get_categories_term
		public static function get_categories_term( array $args = array() ) {
		...
		public static function get_categories_taxanomy( array $args = array() ) {
		...
		// get_locations_term
		public static function get_locations_term( array $args = array() ) {
		...
		// get_tags_term
		public static function get_tags_term( array $args = array() ) {
