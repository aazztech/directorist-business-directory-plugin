...
class Builder_Data {
	...
	protected static function prepare_data() {
		...
		$single_listings_contents_widgets = array(
					...
					array(
						...
						'review'                 => array(
							...
							'options'          => array(
								...
								'review_cookies_consent' => array(
									'label' => __( 'Show Cookies Consent', 'directorist' ),
									'type'  => 'toggle',
									'value' => false,
								),
								'review_enable_gdpr_consent' => array(
									'label' => __( 'Enable GDPR Consent', 'directorist' ),
									'type'  => 'toggle',
									'value' => false,
								),
								'review_gdpr_consent_label' => array(
						...
						'related_listings'       => array(
							...
							'options' => array(
								...
								'similar_listings_logics'  => array(
									'type'    => 'radio',
									'name'    => 'similar_listings_logics',
									'label'   => __( 'Related listings criteria', 'directorist' ),
									'options' => array(
										array(
											'id'    => 'match_category_nd_location',
											'label' => __( 'Match both category and tag', 'directorist' ),
											'value' => 'AND',
										),
										array(
											'id'    => 'match_category_or_location',
											'label' => __( 'Match either category or tag', 'directorist' ),
											'value' => 'OR',
										),
									),
									'value'   => 'OR',
								),
								'listing_from_same_author' => array(
									'type'  => 'toggle',
									'label' => __( 'Display listings by the same author', 'directorist' ),
									'value' => false,
								),
								'similar_listings_number_of_listings_to_show' => array(
									'type'  => 'range',
									'min'   => 0,
									'max'   => 20,
								...
								'similar_listings_number_of_columns' => array(
									'type'  => 'range',
									'min'   => 1,
									'max'   => 4,
					...
					'widgets'       => array(
						...
						'pricing'      => array(
							'options' => array(
								...
								'price_range_min_placeholder' => array(
									'type'  => 'text',
									'label' => __( 'Price Range Min Placeholder', 'directorist' ),
									'value' => 'Min',
								),
								'price_range_max_placeholder' => array(
									'type'  => 'text',
					...
					'options'  => array(
						...
						'fields' => array(
							'align' => array(
								...
								'options' => array(
									array(
										'id'    => 'atbdp_user_avatar_align_right',
										'label' => __( 'Right', 'directorist' ),
										'value' => 'right',
									),
									array(
										'id'    => 'atbdp_user_avatar_align_center',
										'label' => __( 'Center', 'directorist' ),
										'value' => 'center',
									),
									array(
										'id'    => 'atbdp_user_avatar_align_left',
		...
		// Card Layouts
		$listing_card_grid_view_with_thumbnail_layout = array(
			'thumbnail' => array(
				'top_right'    => array(
					'label'             => __( 'Top Right', 'directorist' ),
					'maxWidget'         => 3,
					'maxWidgetInfoText' => 'Up to __DATA__ item{s} can be added',
					'acceptedWidgets'   => array( 'favorite_badge', 'popular_badge', 'featured_badge', 'new_badge' ),
				),
				'top_left'     => array(
					'maxWidget'       => 3,
					'acceptedWidgets' => array( 'favorite_badge', 'popular_badge', 'featured_badge', 'new_badge' ),
				...
				'avatar'       => array(
					'maxWidget'       => 1,
					'acceptedWidgets' => array( 'user_avatar' ),
				),
			),
			...
			'footer'    => array(
				'right' => array(
					'maxWidget'       => 2,
					'acceptedWidgets' => array( 'category', 'favorite_badge', 'view_count' ),
				),
		...
		$listing_card_grid_view_without_thumbnail_layout = array(
			'body'   => array(
				'avatar'        => array(
				...
				'title'         => array(
					'maxWidget'       => 1,
					'acceptedWidgets' => array( 'listing_title' ),
				),
				'quick_actions' => array(
					'maxWidget'       => 2,
					'acceptedWidgets' => array( 'favorite_badge' ),
				),
				'quick_info'    => array(
					'acceptedWidgets' => array( 'favorite_badge', 'popular_badge', 'featured_badge', 'new_badge', 'rating', 'pricing' ),
				),
				'bottom'        => array(
					'maxWidget'       => 0,
					'acceptedWidgets' => array(
		...
		$listing_card_list_view_with_thumbnail_layout = array(
			'thumbnail' => array(
				'top_right' => array(
					'label'             => __( 'Top Right', 'directorist' ),
					'maxWidget'         => 3,
			...
			'body'      => array(
				'top'     => array(
					...
					'maxWidget'         => 0,
					'maxWidgetInfoText' => 'Up to __DATA__ item{s} can be added',
					'acceptedWidgets'   => array( 'listing_title', 'favorite_badge', 'popular_badge', 'featured_badge', 'new_badge', 'rating', 'pricing', 'posted_date' ),
				),
				'right'   => array(
			...
			'footer'    => array(
				'right' => array(
					'maxWidget'       => 2,
					'acceptedWidgets' => array( 'user_avatar', 'category', 'favorite_badge', 'view_count' ),
				),
		...
		$listing_card_list_view_without_thumbnail_layout = array(
			'body'   => array(
				'top'     => array(
					'label'             => __( 'Body Top', 'directorist' ),
					'maxWidget'         => 0,
					'maxWidgetInfoText' => 'Up to __DATA__ item{s} can be added',
					'acceptedWidgets'   => array( 'listing_title', 'favorite_badge', 'popular_badge', 'featured_badge', 'new_badge', 'rating', 'pricing' ),
				),
				'right'   => array(
					'label'             => __( 'Body Right', 'directorist' ),
					'maxWidget'         => 2,
		...
		self::$fields = apply_filters(
			...
			array(
				...
				'enable_single_listing_page' => array(
					'type'        => 'toggle',
...
',
				...
				'single_listings_shortcodes' => array(
					'type'        => 'shortcode-list',
					'buttonLabel' => '<i class="fas fa-magic"></i>',
				...
				'single_listing_header'      => apply_filters(
					...
					array(
						...
						'options_layout' => array(
							'header'        => array( 'back', 'section_title' ),
							'contents_area' => array( 'title_and_tagline', 'description' ),
						),
						'widgets'        => array(
							'back'          => array(
								'type'  => 'button',
						...
						'layout'         => array(
							array(
								...
								'placeholders'   => array(
									...
									array(
										...
										'maxWidget'       => 0,
										'maxWidgetInfoText' => 'Up to __DATA__ item{s} can be added',
										'acceptedWidgets' => array( 'bookmark', 'share', 'report' ),
									),
								),
							),
							array(
							...
							array(
								...
								'maxWidget'         => 0,
								'maxWidgetInfoText' => 'Up to __DATA__ item{s} can be added',
								'acceptedWidgets'   => array( 'location', 'category', 'ratings_count', 'badges', 'price' ),
								'rejectedWidgets'   => array( 'slider' ),
							),
							array(
								'type'            => 'placeholder_item',
								'label'           => 'Slider Widget',
								'placeholderKey'  => 'slider-placeholder',
								'selectedWidgets' => array( 'slider' ),
								'acceptedWidgets' => array( 'slider' ),
								'maxWidget'       => 1,
								'canDelete'       => true,
								'insertByButton'  => true,
								'insertButton'    => array(
				...
				'listings_card_grid_view'    => apply_filters(
					...
					array(
						...
						'card_templates' => array(
							'grid_view_with_thumbnail'    => array(
							...
							'grid_view_without_thumbnail' => array(
		...
		if ( get_directorist_option( 'guest_listings', 1 ) == '1' ) {
			self::$fields['guest_email_label'] = array(
				'label' => __( 'Guest Email Label', 'directorist' ),
				'type'  => 'text',
				'value' => 'Email Address',
			);

			self::$fields['guest_email_placeholder'] = array(
